      ...
      <div className="location-details">
        ...
        <div className="property-info">
          <span>
            ...
            <img className="property-profile-pic" src={property.host.profileImage} alt="Host" />
          </span>
        ...
        <p className="prop-description">
          ...
          Enjoy easy access to local attractions, vibrant neighborhoods, and excellent dining options. Whether you're here for work or to explore,
          this cozy space ensures a memorable stay in South Africa's bustling metropolis.
        </p>
