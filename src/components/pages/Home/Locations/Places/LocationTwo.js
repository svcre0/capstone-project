...
const LocationTwo = () => {
  // Property details and logic
  const property = {
    title: 'Modern Apartment in the Heart of the Durban City',
    description: 'Entire apartment hosted by Romeo',
    price: '$200 ',
    ratings: 4.8,
    images: [
      'https://a0.muscache.com/im/pictures/prohost-api/Hosting-945423970626132050/original/9c17eede-7e23-4d54-93ba-d700584c1a1d.jpeg?im_w=960&im_format=avif',
      'https://a0.muscache.com/im/pictures/miso/Hosting-25178105/original/0686f3f4-972f-4b52-9ba2-176524566d7e.jpeg?im_w=720&im_format=avif',
      'https://a0.muscache.com/im/pictures/miso/Hosting-25178105/original/04b4aa01-7d99-46fb-9c2d-a105c212be76.jpeg?im_w=720&im_format=avif',
      'https://a0.muscache.com/im/pictures/miso/Hosting-885569614483496560/original/2578a298-38c2-471c-8f86-309132a136e6.jpeg?im_w=720&im_format=avif',
      'https://a0.muscache.com/im/pictures/miso/Hosting-1287059602334753636/original/ed0df2a9-5557-4778-94ee-87721ff30cf9.jpeg?im_w=720&im_format=avif',
    ],
    amenities: [
  ...
  // Reserve the booking and store data in localStorage
  const handleReserve = () => {
    const userLoggedIn = localStorage.getItem('userLoggedIn'); // Assuming login status is stored here
    ...
    if (!userLoggedIn) {
      ...
      navigate('/view-reservation');  // Example of navigation after reservation
    }
  };
    ...
    <>
      ...
      <div className="location-details">
        ...
        <div className="right-section">
          <ShareIcon className="top-icon1" /><span className="share">Share</span>
          <FavoriteBorderIcon className="top-icon2" /><span className="save">Save</span>
        </div>
        ...
        <div className="property-info">
          <span>
            ...
            <img className="property-profile-pic" src={property.host.profileImage} alt="Airbnb stats" />
          </span>
          ...
          <div className="reserve">
            <div className="reserve-section-calculator">
              ...
              <div className="reserve-lower-section">
                <span>
                  <h3>$200 x {calculateNights()} night(s)</h3><p>${calculateNights() * 80}</p>
                </span>
